// ------------------------------------------------------------
// Normal visualisation sphere over gradient (Ray Tracing in One Weekend – step)
// ------------------------------------------------------------
...
//  - Si el rayo intersecta la esfera -> color = 0.5*(n + 1) (mapea la normal de [-1,1] a [0,1]).
...
// Color del rayo: visualiza la normal si golpea la esfera, fondo gradiente si no.
